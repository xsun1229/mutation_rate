...
1.  We set #of obs/#of exp $\tilde{\theta_i}$ for each window $i$, the mean value of $\tilde{\theta_i}$ is 1.

We sample the #of obs/#of exp from uniform distribution. The window sizes for the local # of obs/ # of exps range from hundreds kb to 1mb (sampled from unifrom distribution). max(#of obs/#of exp) varies from 1 to 5,  mean(#of obs/#of exp) == 1

Below is an example for the #of obs/#of exp
...
plot(randeff, type="l", ylab = "#of obs/#of exp")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_1kb_maxiter50_maxrandeff1_round2.rdata")

print("maximum # of obs/ # of exp = 1")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_1kb_maxiter50_maxrandeff3_round2.rdata")

print("maximum # of obs/ # of exp = 3")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_1kb_maxiter50_maxrandeff5_round2.rdata")

print("maximum # of obs/ # of exp = 5")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_10kb_maxiter50_maxrandeff1_round2.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_30kb_maxiter50_maxrandeff1_round2.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_50kb_maxiter50_maxrandeff1_round2.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_100kb_maxiter50_maxrandeff1_round2.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_1kb_maxiter50_maxrandeff1_nonspatial.rdata")

print(paste0("maximum # of obs/ # of exp =" ,max(data$randeff_simulated)))
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_1kb_maxiter50_maxrandeff3_nonspatial.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_1kb_maxiter50_maxrandeff5_nonspatial.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_10kb_maxiter50_maxrandeff1_nonspatial.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_30kb_maxiter50_maxrandeff1_nonspatial.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_50kb_maxiter50_maxrandeff1_nonspatial.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_100kb_maxiter50_maxrandeff1_nonspatial.rdata")
