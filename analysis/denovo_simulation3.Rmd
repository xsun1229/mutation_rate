...
1.  We set fold change $\tilde{\theta_i}$ for each window $i$, the mean value of $\tilde{\theta_i}$ is 1.

We sample the fold change from uniform distribution. The window sizes for the local fold changes range from hundreds kb to 1mb (sampled from unifrom distribution). fold change varies from 0 to 5,  mean(fold change) == 1
...
num_windows_all <- 20000
dat_rl <- fread("/project/xinhe/xsun/mutation_rate/6.de_novo_ssc_trost/data/per_chr_processed/chr1/rl_ssc_trost_combine_chr1_1000.txt")
