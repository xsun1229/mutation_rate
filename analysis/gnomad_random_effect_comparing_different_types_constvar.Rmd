...
print("9Mb")
dat_all <- dat_all[dat_all$mb >21 &dat_all$mb <30, ]
dat_ac <- dat_ac[dat_ac$mb >21 &dat_ac$mb <30, ]
dat_at <- dat_at[dat_at$mb >21 &dat_at$mb <30, ]
dat_ag <- dat_ag[dat_ag$mb >21 &dat_ag$mb <30, ]
dat_ca <- dat_ca[dat_ca$mb >21 &dat_ca$mb <30, ]
dat_cg <- dat_cg[dat_cg$mb >21 &dat_cg$mb <30, ]
dat_ct <- dat_ct[dat_ct$mb >21 &dat_ct$mb <30, ]
...
print("5Mb")
dat_all <- dat_all[dat_all$mb >21 &dat_all$mb <26, ]
dat_ac <- dat_ac[dat_ac$mb >21 &dat_ac$mb <26, ]
dat_at <- dat_at[dat_at$mb >21 &dat_at$mb <26, ]
dat_ag <- dat_ag[dat_ag$mb >21 &dat_ag$mb <26, ]
dat_ca <- dat_ca[dat_ca$mb >21 &dat_ca$mb <26, ]
dat_cg <- dat_cg[dat_cg$mb >21 &dat_cg$mb <26, ]
dat_ct <- dat_ct[dat_ct$mb >21 &dat_ct$mb <26, ]
...
print("1Mb")
dat_all <- dat_all[dat_all$mb >22 &dat_all$mb <23, ]
dat_ac <- dat_ac[dat_ac$mb >22 &dat_ac$mb <23, ]
dat_at <- dat_at[dat_at$mb >22 &dat_at$mb <23, ]
dat_ag <- dat_ag[dat_ag$mb >22 &dat_ag$mb <23, ]
dat_ca <- dat_ca[dat_ca$mb >22 &dat_ca$mb <23, ]
dat_cg <- dat_cg[dat_cg$mb >22 &dat_cg$mb <23, ]
dat_ct <- dat_ct[dat_ct$mb >22 &dat_ct$mb <23, ]
...
print("0.5Mb")
dat_all <- dat_all[dat_all$mb >22.5 &dat_all$mb <23, ]
dat_ac <- dat_ac[dat_ac$mb >22.5 &dat_ac$mb <23, ]
dat_at <- dat_at[dat_at$mb >22.5 &dat_at$mb <23, ]
dat_ag <- dat_ag[dat_ag$mb >22.5 &dat_ag$mb <23, ]
dat_ca <- dat_ca[dat_ca$mb >22.5 &dat_ca$mb <23, ]
dat_cg <- dat_cg[dat_cg$mb >22.5 &dat_cg$mb <23, ]
dat_ct <- dat_ct[dat_ct$mb >22.5 &dat_ct$mb <23, ]
...
```{r echo=FALSE, message=FALSE, warning=FALSE,fig.height=25, fig.width=40}
...
p1 <- ggplot(dat, aes(x = dat1, y = dat2)) +
  ...
  geom_smooth(method = lm, formula = y ~ x + 0, color = "red",size=0.2) +annotate("text", x = max(dat$dat1), y = max(dat$dat2), label = paste0("fitting p-value: ", round(adj.rsq, 4)), vjust = 1, hjust = 1,size=5)+
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5))
