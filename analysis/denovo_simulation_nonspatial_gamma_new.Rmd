...
# Checking if the algorithm recovers the correct alpha -- sample all windows from gamma distribution 

1. Use Gamma prior to sample $\theta_i$ in the simulation: $$ \theta_{i} \sim Gamma(\alpha,\alpha)$$  for all windows. Alpha was varied from 5 to 50. 

2. We used "L-BFGS-B","BFGS","Simplex (Nelder-Mead)" and "CG" to optimize the likelihood function. Initial Alpha was set to 1,3,5.
...
# Checking if the algorithm recover the alpha -- sample hot spots from gamma distribution

## 10kb

```{r echo=F, message=FALSE, warning=FALSE, fig.width=5, fig.height=5}
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_10kb_alpha_init1_hotspot.rdata")

# Create the plot
ggplot(data, aes(x = alpha_true_all)) +
  geom_point(aes(y = alpha_simplex_all, color = "Simplex(Nelder-Mead)")) +
  geom_abline(intercept = 0, slope = 1, linetype = "dashed", color = "gray") +
  labs(x = "True Alpha", y = "Alpha estimated",title = "initial alpha = 1") +
  scale_color_manual(values = c("Simplex(Nelder-Mead)" = "orange")) +
  theme_minimal()
```
...
```{r echo=F, message=FALSE, warning=FALSE, fig.width=5, fig.height=5}
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_30kb_alpha_init1_hotspot.rdata")
...
```{r echo=F, message=FALSE, warning=FALSE, fig.width=5, fig.height=5}
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_50kb_alpha_init1_hotspot.rdata")
...
```{r echo=F, message=FALSE, warning=FALSE, fig.width=5, fig.height=5}
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_100kb_alpha_init1_hotspot.rdata")
...
# Simulation  -- the hot spots were sampled with a gamma prior

1. Selecting 5% of the windows to be hotspots

2. Sampling the values for these hotspots from $gamma(\alpha,\alpha)$, the alpha was set to 5,10,30,50.

3. Setting  the value of other windows as 0. 

4. Estimating alpha for all of the windows 
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_10kb_gammaprior5_init1_nonspatial_gamma_simp.rdata")

print(sprintf("the estimated alpha = %s", alpha))
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_10kb_gammaprior10_init1_nonspatial_gamma_simp.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_10kb_gammaprior30_init1_nonspatial_gamma_simp.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_10kb_gammaprior50_init1_nonspatial_gamma_simp.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_30kb_gammaprior5_init1_nonspatial_gamma_simp.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_30kb_gammaprior10_init1_nonspatial_gamma_simp.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_30kb_gammaprior30_init1_nonspatial_gamma_simp.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_30kb_gammaprior50_init1_nonspatial_gamma_simp.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_50kb_gammaprior5_init1_nonspatial_gamma_simp.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_50kb_gammaprior10_init1_nonspatial_gamma_simp.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_50kb_gammaprior30_init1_nonspatial_gamma_simp.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_50kb_gammaprior50_init1_nonspatial_gamma_simp.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_100kb_gammaprior5_init1_nonspatial_gamma_simp.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_100kb_gammaprior10_init1_nonspatial_gamma_simp.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_100kb_gammaprior30_init1_nonspatial_gamma_simp.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_100kb_gammaprior50_init1_nonspatial_gamma_simp.rdata")
...
<!-- # Simulation -- the hot spots were sampled from uniform distribution -->
