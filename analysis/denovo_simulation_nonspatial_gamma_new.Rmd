...
We first check if the algorithm recovers the correct alpha. Use Gamma prior to sample $\theta_i$ in the simulation. Alpha was varied from 5 to 50. Initial Alpha was set to 1,3,5. We used "L-BFGS-B","BFGS" and "CG" to optimize the likelihood function.
...
From the results above, the results are sensitive to the initial alpha and methods. It seems "L-BFGS-B" is the most stable method and 5 is a good initial alpha. 

So we used "L-BFGS-B" and initial alpha =1/3/5 to do the simulation

Random effects were assigned to 10% of the windows, with non-zero values

## 10kb

### max maximum fold change = 3

The initial alpha doesn't influence estimated alpha

```{r echo=F, message=FALSE, warning=FALSE, fig.width=12, fig.height=5}

load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_10kb_maxrandeff3_init1_nonspatial_gamma_more_lb.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_10kb_maxrandeff5_init1_nonspatial_gamma_more_lb.rdata")
...
"L-BFGS-B" doesn't work when maximum fold change = 10, init alpha = 1/3/5
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_30kb_maxrandeff3_init1_nonspatial_gamma_more_lb.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_30kb_maxrandeff5_init1_nonspatial_gamma_more_lb.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_50kb_maxrandeff3_init1_nonspatial_gamma_more_lb.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_50kb_maxrandeff5_init1_nonspatial_gamma_more_lb.rdata")
...
The initial alpha doesn't influence estimated alpha a lot

```{r echo=F, message=FALSE, warning=FALSE, fig.width=12, fig.height=5}

load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_100kb_maxrandeff3_init1_nonspatial_gamma_more_lb.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_100kb_maxrandeff5_init1_nonspatial_gamma_more_lb.rdata")
...
load("/project/xinhe/xsun/mutation_rate/7.denovo_simulation/results/simu_chr1_100kb_maxrandeff10_init1_nonspatial_gamma_more_lb.rdata")
