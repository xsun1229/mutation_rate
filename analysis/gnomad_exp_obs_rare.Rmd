...
merged_ac <- fread("/project/xinhe/xsun/mutation_rate/1.exp_obs_gnomad/results/exp_merged_ac_rare_chr22_rescal.csv")
merged_ag <- fread("/project/xinhe/xsun/mutation_rate/1.exp_obs_gnomad/results/exp_merged_ag_rare_chr22_rescal.csv")
merged_at <- fread("/project/xinhe/xsun/mutation_rate/1.exp_obs_gnomad/results/exp_merged_at_rare_chr22_rescal.csv")
merged_ca <- fread("/project/xinhe/xsun/mutation_rate/1.exp_obs_gnomad/results/exp_merged_ca_rare_chr22_rescal.csv")
merged_cg <- fread("/project/xinhe/xsun/mutation_rate/1.exp_obs_gnomad/results/exp_merged_cg_rare_chr22_rescal.csv")
merged_ct <- fread("/project/xinhe/xsun/mutation_rate/1.exp_obs_gnomad/results/exp_merged_ct_rare_chr22_rescal.csv")
...
obs_ac <- fread("/project/xinhe/xsun/mutation_rate/1.exp_obs_gnomad/results/obs_ac_rare_chr22_rescal.csv")
obs_ag <- fread("/project/xinhe/xsun/mutation_rate/1.exp_obs_gnomad/results/obs_ag_rare_chr22_rescal.csv")
obs_at <- fread("/project/xinhe/xsun/mutation_rate/1.exp_obs_gnomad/results/obs_at_rare_chr22_rescal.csv")
obs_ca <- fread("/project/xinhe/xsun/mutation_rate/1.exp_obs_gnomad/results/obs_ca_rare_chr22_rescal.csv")
obs_cg <- fread("/project/xinhe/xsun/mutation_rate/1.exp_obs_gnomad/results/obs_cg_rare_chr22_rescal.csv")
obs_ct <- fread("/project/xinhe/xsun/mutation_rate/1.exp_obs_gnomad/results/obs_ct_rare_chr22_rescal.csv")
```
...
print(paste0("The expected number of positions that are polymorphic = ", sum(merged_ac$p_rescale,na.rm = T)))

print("A-G")
print(paste0("The observed number of positions that are polymorphic = ", sum(!duplicated(obs_ag$POS))))
print(paste0("The expected number of positions that are polymorphic = ", sum(merged_ag$p_rescale,na.rm = T)))

print("A-T")
print(paste0("The observed number of positions that are polymorphic = ", sum(!duplicated(obs_at$POS))))
print(paste0("The expected number of positions that are polymorphic = ", sum(merged_at$p_rescale,na.rm = T)))

print("C-A")
print(paste0("The observed number of positions that are polymorphic = ", sum(!duplicated(obs_ca$POS))))
print(paste0("The expected number of positions that are polymorphic = ", sum(merged_ca$p_rescale,na.rm = T)))

print("C-G")
print(paste0("The observed number of positions that are polymorphic = ", sum(!duplicated(obs_cg$POS))))
print(paste0("The expected number of positions that are polymorphic = ", sum(merged_cg$p_rescale,na.rm = T)))

print("C-T")
print(paste0("The observed number of positions that are polymorphic = ", sum(!duplicated(obs_ct$POS))))
print(paste0("The expected number of positions that are polymorphic = ", sum(merged_ct$p_rescale,na.rm = T)))
...
print(paste0("The expected allele coun = ", sum(merged$MR_rescale,na.rm = T)))
```
...
print(paste0("The expected allele count = ", sum(merged_ac$MR_rescale,na.rm = T)))

print("A-G")
print(paste0("The observed allele count = ", sum(obs_ag$AC,na.rm = T)))
print(paste0("The expected allele count = ", sum(merged_ag$MR_rescale,na.rm = T)))

print("A-T")
print(paste0("The observed allele count = ", sum(obs_at$AC,na.rm = T)))
print(paste0("The expected allele count = ", sum(merged_at$MR_rescale,na.rm = T)))

print("C-A")
print(paste0("The observed allele count = ", sum(obs_ca$AC,na.rm = T)))
print(paste0("The expected allele count = ", sum(merged_ca$MR_rescale,na.rm = T)))

print("C-G")
print(paste0("The observed allele count = ", sum(obs_cg$AC,na.rm = T)))
print(paste0("The expected allele count = ", sum(merged_cg$MR_rescale,na.rm = T)))

print("C-T")
print(paste0("The observed allele count = ", sum(obs_ct$AC,na.rm = T)))
print(paste0("The expected allele count = ", sum(merged_ct$MR_rescale,na.rm = T)))
...
expected <- c(sum(merged_at$MR_rescale,na.rm = T),sum(merged_ac$MR_rescale,na.rm = T),sum(merged_ag$MR_rescale,na.rm = T),sum(merged_ct$MR_rescale,na.rm = T),sum(merged_cg$MR_rescale,na.rm = T),sum(merged_ca$MR_rescale,na.rm = T))
