...
We grouped the chr1 and chr22 into 10kb windows. In each window, we used the first 90% sites as training data, and the remaining 10% as the testing data. 
...
file <- paste0("/project/xinhe/xsun/mutation_rate/3.de_novo/results/per_chr/chr1/gaus_10kb_pseudo0005_traintest.rdata")
load(file)
