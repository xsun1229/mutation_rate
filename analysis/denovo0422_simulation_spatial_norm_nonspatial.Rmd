...
p1 <- plot_model(data = dat, estimate_column = "randeff_est_sp_only", title = "spatial only")
p2 <- plot_model(data = dat, estimate_column = "randeff_est_nsp_only", title = "non-spatial only", alpha_est = alpha_est_nsp_only)
p3 <- plot_model(data = dat, estimate_column = "randeff_est_sf_ns_final", title = "spatial & non-spatial", alpha_est = alpha_est_sf_ns)
grid.arrange(p1, p2,p3, ncol = 3)

dat$exp_sf_nsp_final <- dat$exp*dat$randeff_est_sf_ns_final
p1 <- scatter_plot_mutct(data = dat, xcol = "exp_sp_only", ycol = "y_sample", title = "spatial only")
p2 <- scatter_plot_mutct(data = dat, xcol = "exp_nsp_only", ycol = "y_sample", title = "non-spatial only")
p3 <- scatter_plot_mutct(data = dat, xcol = "exp_sf_nsp_final", ycol = "y_sample", title = "spatial & non-spatial")
p4 <- scatter_plot_mutct(data = dat, xcol ="roulette" , ycol = "y_sample", title = "roulette")
