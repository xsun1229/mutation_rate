...
plot_model <- function(data, estimate_column, title, alpha_est = NULL,colcol) {
  ...
  # 
  p <- ggplot(data) +
  geom_point(data = data[data[[colcol]] == "FALSE", ], aes(x = randeff_simulated, y = get(estimate_column)), 
             color = "black", alpha = 0.5) +
  geom_point(data = data[data[[colcol]] == "TRUE", ], aes(x = randeff_simulated, y = get(estimate_column)), 
...
p4 <- scatter_plot_mutct(data = dat, xcol ="roulette" , ycol = "y_sample", title = "roulette",colcol = "spatial_effect")
