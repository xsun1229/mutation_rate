---
title: "Data cleaning -- Intergration of MSSNG, ASC, SPARK (Trost et al, Cell 2022) "
author: "XSun"
date: "2024-06-19"
output:
...
We checked the gaps from Roulette estimation here and get an overview for the observed fold change $r_i$ computed from intergration of MSSNG, ASC, SPARK (Trost et al, Cell 2022)
...
load("/project/xinhe/xsun/mutation_rate/13.denovo_real_integration_trost/data_cleaning/integration_trost_per_window_chr1_100kb_frac4.rdata")
...
load("/project/xinhe/xsun/mutation_rate/13.denovo_real_integration_trost/data_cleaning/integration_trost_per_window_chr1_10kb_frac4.rdata")
...
load("/project/xinhe/xsun/mutation_rate/13.denovo_real_integration_trost/data_cleaning/integration_trost_per_window_chr1_30kb_frac4.rdata")
...
load("/project/xinhe/xsun/mutation_rate/13.denovo_real_integration_trost/data_cleaning/integration_trost_per_window_chr1_50kb_frac4.rdata")
