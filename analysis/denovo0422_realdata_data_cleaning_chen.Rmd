---
title: "Data cleaning -- SSC + deCODE"
author: "XSun"
date: "2025-03-5"
output:
...
https://www.science.org/doi/10.1126/science.aau1043 (deCODE genetics database, 2976 trios)
https://www.science.org/doi/10.1126/science.aat6576 (SSC)
...
```{r}
load("/project/xinhe/xsun/mutation_rate/15.denovo_real_chen/data_cleaning/gap_summary_chr1.rdata")
...
load("/project/xinhe/xsun/mutation_rate/15.denovo_real_chen/data_cleaning/chen_per_window_chr1_100kb_frac4_halftt.rdata")
...
Each window's positions are divided into a training set (50%) and a testing set for cross-validation.
...
load("/project/xinhe/xsun/mutation_rate/15.denovo_real_chen/data_cleaning/chen_per_window_chr1_50kb_frac4_halftt.rdata")

df_per_window_data$foldchange <- df_per_window_data$obs_sum/df_per_window_data$rl_rescaled_sum
...
load("/project/xinhe/xsun/mutation_rate/15.denovo_real_chen/data_cleaning/chen_per_window_chr1_500kb_frac4_halftt.rdata")
