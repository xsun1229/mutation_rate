...
We divide the genome into windows. The window sizes for the local random effects range from hundreds kb to 1mb.
...
The posterior distribution of $\tilde{\theta_{i}}$ is :
...
1. Use Gamma prior to sample $\theta_i$ in the simulation: $$\tilde{\theta_{i}} \sim Gamma(\alpha,\alpha)$$  for all windows. The prior $\alpha \in \{5,10,30,50\}$
