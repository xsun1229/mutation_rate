...
```{r echo=FALSE, message=FALSE, warning=FALSE,fig.height=5, fig.width=20}
merged <- fread("/project/xinhe/xsun/mutation_rate/1.exp_obs_gnomad/results/chr22_ac_rescale.bed")
colnames(merged) <- c("chr","start","end", "MR_exp","AC_obs")
...
```{r echo=FALSE, message=FALSE, warning=FALSE,fig.height=5, fig.width=20}
merged <- fread("/project/xinhe/xsun/mutation_rate/1.exp_obs_gnomad/results/chr22_at_rescale.bed")
colnames(merged) <- c("chr","start","end", "MR_exp","AC_obs")
...
```{r echo=FALSE, message=FALSE, warning=FALSE,fig.height=5, fig.width=20}
merged <- fread("/project/xinhe/xsun/mutation_rate/1.exp_obs_gnomad/results/chr22_ag_rescale.bed")
colnames(merged) <- c("chr","start","end", "MR_exp","AC_obs")
...
```{r echo=FALSE, message=FALSE, warning=FALSE,fig.height=5, fig.width=20}
merged <- fread("/project/xinhe/xsun/mutation_rate/1.exp_obs_gnomad/results/chr22_ca_rescale.bed")
colnames(merged) <- c("chr","start","end", "MR_exp","AC_obs")
...
```{r echo=FALSE, message=FALSE, warning=FALSE,fig.height=5, fig.width=20}
merged <- fread("/project/xinhe/xsun/mutation_rate/1.exp_obs_gnomad/results/chr22_ct_rescale.bed")
colnames(merged) <- c("chr","start","end", "MR_exp","AC_obs")
